...
public class RestTests2()
{
    ...
    [Test]
    [MethodDataSource(typeof(PlatformTypes2), nameof(PlatformTypes2.SupportedPlatformTypes))]
    ...
    [Test]
    [MethodDataSource(typeof(PlatformTypes2), nameof(PlatformTypes2.SupportedRealDeviceTypes))]
    ...
    [Test]
    [MethodDataSource(typeof(PlatformTypes2), nameof(PlatformTypes2.PlatformsWithBrowsersTypes))]
