...
public class RestTests3()
{
    ...
    [Test]
    [MethodDataSource(typeof(PlatformTypes3), nameof(PlatformTypes3.SupportedPlatformTypes))]
    ...
    [Test]
    [MethodDataSource(typeof(PlatformTypes3), nameof(PlatformTypes3.SupportedRealDeviceTypes))]
    ...
    [Test]
    [MethodDataSource(typeof(PlatformTypes3), nameof(PlatformTypes3.PlatformsWithBrowsersTypes))]
