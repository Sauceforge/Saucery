...
internal static class PlatformExtensions {
    ...
    public static bool IsAnIPhone(this BrowserVersion browserVersion) => browserVersion.DeviceName != null && browserVersion.DeviceName.Contains(SauceryConstants.APPLE_IPHONE, StringComparison.CurrentCultureIgnoreCase);

    public static bool IsAnIPad(this BrowserVersion browserVersion) => browserVersion.DeviceName != null && browserVersion.DeviceName.Contains(SauceryConstants.APPLE_IPAD, StringComparison.CurrentCultureIgnoreCase);

    public static bool IsAnAppleDevice(this SaucePlatform platform) => IsAnIPhone(platform) || IsAnIPad(platform);

    public static bool IsAnIPhone(this SaucePlatform platform) => platform.LongName != null && platform.LongName.Contains(SauceryConstants.APPLE_IPHONE, StringComparison.CurrentCultureIgnoreCase);

    public static bool IsAnIPad(this SaucePlatform platform) => platform.LongName != null && platform.LongName.Contains(SauceryConstants.APPLE_IPAD, StringComparison.CurrentCultureIgnoreCase);
