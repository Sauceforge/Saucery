...
public class DesktopFactoryVersionTests2() 
{
    ...
    [Test]
    [MethodDataSource(typeof(DesktopDataClass2), nameof(DesktopDataClass2.NotSupportedTestCases))]
    ...
    [Test]
    [MethodDataSource(typeof(DesktopDataClass2), nameof(DesktopDataClass2.SupportedTestCases))]
...
public static class DesktopDataClass2
{
