...
public class RestTests5()
{
    ...
    [Test]
    [MethodDataSource(typeof(PlatformTypes5), nameof(PlatformTypes5.SupportedPlatformTypes))]
    ...
    [Test]
    [MethodDataSource(typeof(PlatformTypes5), nameof(PlatformTypes5.SupportedRealDeviceTypes))]
    ...
    [Test]
    [MethodDataSource(typeof(PlatformTypes5), nameof(PlatformTypes5 .PlatformsWithBrowsersTypes))]
