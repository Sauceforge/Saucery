...
public class DesktopFactoryVersionTests5() 
{
    ...
    [Test]
    [MethodDataSource(typeof(DesktopDataClass5), nameof(DesktopDataClass5.NotSupportedTestCases))]
    ...
    [Test]
    [MethodDataSource(typeof(DesktopDataClass5), nameof(DesktopDataClass5.SupportedTestCases))]
...
public static class DesktopDataClass5
{
