...
public class AndroidFactoryVersionTests5 {
    ...
    [Test]
    [MethodDataSource(typeof(AndroidDataClass5), nameof(AndroidDataClass5.NotSupportedTestCases))]
    ...
    [Test]
    [MethodDataSource(typeof(AndroidDataClass5), nameof(AndroidDataClass5.SupportedTestCases))]
...
public static class AndroidDataClass5 {
