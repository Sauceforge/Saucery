...
public class SauceryConstants {
    ...
    internal static List<string> BROWSER_VERSIONS_NONNUMERIC = new List<string>() { BROWSER_VERSION_BETA, BROWSER_VERSION_DEV }.Concat(BROWSER_VERSIONS_LATEST).ToList();
