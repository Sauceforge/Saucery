...
public class IOSFactoryVersionTests2() 
{
    ...
    [Test]
    [MethodDataSource(typeof(IOSDataClass2), nameof(IOSDataClass2.NotSupportedTestCases))]
    ...
    [Test]
    [MethodDataSource(typeof(IOSDataClass2), nameof(IOSDataClass2.SupportedTestCases))]
...
internal static class IOSDataClass2
{
    public static IEnumerable<SaucePlatform> SupportedTestCases => IOSPlatformVersions2.Select(v => new IOSPlatform("iPhone Simulator", v, SauceryConstants.DEVICE_ORIENTATION_PORTRAIT));
    ...
    internal static readonly string[] IOSPlatformVersions2 =
    [
        "14.0","14.3","14.4","14.5",
        "15.0","15.2","15.4","15.5",
        "16.0","16.1","16.2","16.4",
