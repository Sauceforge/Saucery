...
public class RealAndroidFactoryVersionTests()
{
    ...
    [Test]
    [MethodDataSource(typeof(RealAndroidDataClass), nameof(RealAndroidDataClass.GetNotSupportedTestCases))]
    ...
    [Test]
    [MethodDataSource(typeof(RealAndroidDataClass), nameof(RealAndroidDataClass.GetSupportedTestCases))]
