...
namespace Saucery.Core.Tests.REST.Data;

public static class PlatformTypes {
    private static readonly Type[] SupportedPlatformTypeValues =
    [
    ...
    private static readonly Type[] SupportedRealDeviceTypeValues =
    [
    ...
    private static readonly Type[] PlatformsWithBrowsersTypeValues =
    [
        typeof(LinuxPlatform),
        typeof(Windows11Platform),
        typeof(Windows10Platform),
    ...
    public static IEnumerable<object?[]> GetSupportedPlatformTypes() => Wrap(SupportedPlatformTypeValues);

    public static IEnumerable<object?[]> GetSupportedRealDeviceTypes() => Wrap(SupportedRealDeviceTypeValues);

    public static IEnumerable<object?[]> GetPlatformsWithBrowsersTypes() => Wrap(PlatformsWithBrowsersTypeValues);

    private static IEnumerable<object?[]> Wrap(IEnumerable<Type> types)
    {
