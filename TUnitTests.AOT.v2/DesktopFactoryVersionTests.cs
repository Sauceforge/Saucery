...
public class DesktopFactoryVersionTests() 
{
    ...
    [Test]
    [MethodDataSource(typeof(DesktopDataClass), nameof(DesktopDataClass.GetNotSupportedTestCases))]
    ...
    [Test]
    [MethodDataSource(typeof(DesktopDataClass), nameof(DesktopDataClass.GetSupportedTestCases))]
