...
namespace Saucery.Core.Tests.XUnitv3.Options;
...
public sealed class ArmRequiredOptionTests {
    ...
    [Theory]
    [InlineData(OptionKind.Chrome)]
    [InlineData(OptionKind.Edge)]
    [InlineData(OptionKind.Firefox)]
    [InlineData(OptionKind.IE)]
    [InlineData(OptionKind.Safari)]
    [InlineData(OptionKind.EmulatedIOS)]
    ...
    [Theory]
    [InlineData(OptionKind.EmulatedAndroid)]
    [InlineData(OptionKind.RealDeviceAndroid)]
    [InlineData(OptionKind.RealDeviceIOS)]
