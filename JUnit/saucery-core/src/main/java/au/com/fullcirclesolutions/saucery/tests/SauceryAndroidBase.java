...
import au.com.fullcirclesolutions.saucery.driver.SauceryAndroidDriver;
...
public class SauceryAndroidBase extends SauceryRoot implements SauceOnDemandSessionIdProvider {
    protected SauceryAndroidDriver Driver;

    public SauceryAndroidBase(String os, String platformType, String browser, String browserVersion, String longName, String longVersion, String url, String device, String deviceOrientation) {
    ...
    public void InitialiseDriver(DesiredCapabilities caps, int waitSecs) {
        ...
        try {
            ...
            Driver = new SauceryAndroidDriver(new URL(fullUrl), caps);
