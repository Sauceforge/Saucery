...
public class AndroidFactoryVersionTests3 {
    ...
    [Test]
    [MethodDataSource(typeof(AndroidDataClass3), nameof(AndroidDataClass3.NotSupportedTestCases))]
    ...
    [Test]
    [MethodDataSource(typeof(AndroidDataClass3), nameof(AndroidDataClass3.SupportedTestCases))]
...
public static class AndroidDataClass3 {
