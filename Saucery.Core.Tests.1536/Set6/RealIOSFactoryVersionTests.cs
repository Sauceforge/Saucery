...
public class RealIOSFactoryVersionTests6() {
    ...
    [Test]
    [MethodDataSource(typeof(RealIOSDataClass6), nameof(RealIOSDataClass6.NotSupportedTestCases))]
    ...
    [Test]
    [MethodDataSource(typeof(RealIOSDataClass6), nameof(RealIOSDataClass6.SupportedTestCases))]
...
public class RealIOSDataClass6 {
