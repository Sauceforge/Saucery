...
using Saucery.Core.Tests.NUnit.REST.Data;
using Shouldly;
...
public class RestTests
{
    ...
    [Test]
    [TestCaseSource(typeof(PlatformTypes), nameof(PlatformTypes.SupportedPlatformTypes))]
    ...
    [Test]
    [TestCaseSource(typeof(PlatformTypes), nameof(PlatformTypes.SupportedRealDeviceTypes))]
    ...
    [Test]
    [TestCaseSource(typeof(PlatformTypes), nameof(PlatformTypes.PlatformsWithBrowsersTypes))]
