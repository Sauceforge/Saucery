...
public class AndroidFactoryVersionTests2 {
    ...
    [Test]
    [MethodDataSource(typeof(AndroidDataClass2), nameof(AndroidDataClass2.NotSupportedTestCases))]
    ...
    [Test]
    [MethodDataSource(typeof(AndroidDataClass2), nameof(AndroidDataClass2.SupportedTestCases))]
...
public static class AndroidDataClass2 {
