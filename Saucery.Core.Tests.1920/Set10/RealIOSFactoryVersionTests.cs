...
public class RealIOSFactoryVersionTests10() {
    ...
    [Test]
    [MethodDataSource(typeof(RealIOSDataClass10), nameof(RealIOSDataClass10.NotSupportedTestCases))]
    ...
    [Test]
    [MethodDataSource(typeof(RealIOSDataClass10), nameof(RealIOSDataClass10.SupportedTestCases))]
...
public class RealIOSDataClass10 {
