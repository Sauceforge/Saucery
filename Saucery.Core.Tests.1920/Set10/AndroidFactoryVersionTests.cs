...
public class AndroidFactoryVersionTests10 {
    ...
    [Test]
    [MethodDataSource(typeof(AndroidDataClass10), nameof(AndroidDataClass10.NotSupportedTestCases))]
    ...
    [Test]
    [MethodDataSource(typeof(AndroidDataClass10), nameof(AndroidDataClass10.SupportedTestCases))]
...
public static class AndroidDataClass10 {
