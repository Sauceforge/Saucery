...
using Set10.REST.Data;
using Shouldly;
using System.Collections;
using System.Reflection;
using System.Runtime.CompilerServices;

namespace Set10.REST;
...
public class RestTests10()
{
    ...
    [Test]
    [MethodDataSource(typeof(PlatformTypes10), nameof(PlatformTypes10.SupportedPlatformTypes))]
    ...
    [Test]
    [MethodDataSource(typeof(PlatformTypes10), nameof(PlatformTypes10.SupportedRealDeviceTypes))]
    ...
    [Test]
    [MethodDataSource(typeof(PlatformTypes10), nameof(PlatformTypes10.PlatformsWithBrowsersTypes))]
