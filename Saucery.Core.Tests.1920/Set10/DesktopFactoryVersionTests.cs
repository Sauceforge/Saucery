...
public class DesktopFactoryVersionTests10() 
{
    ...
    [Test]
    [MethodDataSource(typeof(DesktopDataClass10), nameof(DesktopDataClass10.NotSupportedTestCases))]
    ...
    [Test]
    [MethodDataSource(typeof(DesktopDataClass10), nameof(DesktopDataClass10.SupportedTestCases))]
...
public static class DesktopDataClass10
{
