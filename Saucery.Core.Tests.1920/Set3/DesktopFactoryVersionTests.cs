...
public class DesktopFactoryVersionTests3() 
{
    ...
    [Test]
    [MethodDataSource(typeof(DesktopDataClass3), nameof(DesktopDataClass3.NotSupportedTestCases))]
    ...
    [Test]
    [MethodDataSource(typeof(DesktopDataClass3), nameof(DesktopDataClass3.SupportedTestCases))]
...
public static class DesktopDataClass3
{
